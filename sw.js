...
// Версия: v66 — "Зикры после намаза" переведены в множественное число и
// переработаны в последовательность из 4 этапов (Субханаллах×33 →
// Альхамдулиллях×33 → Аллаху Акбар×33 → Ля иляха илляЛлах×1) с автопереходом
// и сбросом кольца на каждом этапе; бампнуто, чтобы сбросить старый i18n.js.
// Бампать CACHE_NAME при каждом релизе → activate-handler выкинет старый кэш.
const CACHE_NAME = 'azkar-v66';
